...
2. Install the script from one of these sources:
   ...
   - [Direct install - UVP-Ultra-Video-Player-v5.0.36-Mini.user.js][(https://github.com/404Emily404/UVP-Ultra-Video-Player/releases/download/v5.0.36-Mini/UVP-Ultra-Video-Player-v5.0.36-Mini.user.js)]
